...
void vendor_load_properties() {
    ...
    if (sku == "halo") {
        load_device_properties("halo-user 12 SKQ1.220519.001 14.0.555_220925 release-keys", "Lenovo/halo/halo:12/SKQ1.220519.001/14.0.555_220925:user/release-keys", "halo", "Lenovo Legion Y70");
